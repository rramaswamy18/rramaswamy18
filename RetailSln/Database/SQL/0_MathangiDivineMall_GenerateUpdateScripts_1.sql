USE [MathangiDivineMall]
GO
--0_MathangiDivineMall_GenerateUpdateScripts_1.sql
--Aug 6 2025
SET NOCOUNT ON
...
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'Mathangi Divine Mall' WHERE ClientId = @ClientId AND KVPKey = 'Business' AND KVPSubKey = 'NameOnInvoice'
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'Mathangi Divine Mall' WHERE ClientId = @ClientId AND KVPKey = 'BusinessName1'
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'Mathangi Divine Mall' WHERE ClientId = @ClientId AND KVPKey = 'BusinessNameWord1'
...
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'testmahtangiinfo@divinebija.com' WHERE ClientId = @ClientId AND KVPKey = 'BusinessEmail'
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'testmahtangiinfo@divinebija.com' WHERE ClientId = @ClientId AND KVPKey = 'FromEmailAddress'
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'Mathangi Divine Mall Support' WHERE ClientId = @ClientId AND KVPKey = 'FromEmailAddressDisplayName'
...
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'testmathangiinfo@divinebija.com' WHERE ClientId = @ClientId AND KVPKey = 'PrimaryEmailAddress' AND KVPSubKey = ''
END
