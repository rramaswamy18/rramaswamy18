...
SELECT 1 AS PickupLocationId, @ClientId AS ClientId, 'Divine_Bija_Office' AS LocationNameDesc, 'Divine Bija Office' AS LocationDesc, 1 AS LocationDemogInfoAddressId UNION
SELECT 2 AS PickupLocationId, @ClientId AS ClientId, 'SVCC_Temple_Fremont' AS LocationNameDesc, 'SVCC Temple Fremont' AS LocationDesc, 2 AS LocationDemogInfoAddressId UNION
SELECT 3 AS PickupLocationId, @ClientId AS ClientId, 'SVCC_Temple_Sacramento' AS LocationNameDesc, 'SVCC Temple Sacramento' AS LocationDesc, 3 AS LocationDemogInfoAddressId
...
--DemogInfoAddressUploadDev
    ...
    SELECT DemogInfoAddressUploadForDev.DemogInfoAddressId AS DemogInfoAddressId, @ClientId AS ClientId
