USE [RetailSlnMathangi]
GO
--1_RetailSln_PopulateItem_MathangiDivineMall.sql
...
--Begin Item Master
        ...
        SELECT 96 AS ClientId, 'png' AS ImageExtension, Description0 AS ItemMasterDesc0, Description1 AS ItemMasterDesc1
...
--select * from #TEMP1A
        ...
        SELECT DISTINCT 3 AS ClientId, AspNetRoleName, ItemId, ItemMasterId, ItemMasterSeqNum, ItemSeqNum, ParentCategoryId
...
SELECT 'copy "C:\Common\Images\DivineBijaIn\DivineBija_20230927\UploadedImages\' + UploadImageFileName + '" MathangiDivineMallImages\' AS DosCopyCommand, UploadImageFileName, ImageName, ItemMasterId, ItemMasterDesc FROM RetailSlnSch.ItemMaster WHERE ItemMasterId > 0 ORDER BY ItemMasterId
SELECT 'copy "MathangiDivineMallImages\' + UploadImageFileName + '" ItemMaster\ItemMaster' + CAST(ItemMasterId AS VARCHAR) + '.' + ImageExtension AS DosCopyCommand, UploadImageFileName, ImageName, ItemMasterId, ItemMasterDesc FROM RetailSlnSch.ItemMaster WHERE ItemMasterId > 0 ORDER BY ItemMasterId
