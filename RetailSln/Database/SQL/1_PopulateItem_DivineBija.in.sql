...
SELECT * FROM RetailSlnSch.Item WHERE ItemTypeId = 100 ORDER BY ItemId
...
SELECT 3 AS ClientId, 0 AS ParentCategoryId, 1 AS SeqNum, 8 AS CategoryId, NULL AS ItemId, 'Recursive' ProcessType, 'Category' AS CategoryOrItem

--Categories
INSERT RetailSlnSch.CategoryItemHier(ClientId, ParentCategoryId, SeqNum, CategoryId, ItemId, ProcessType, CategoryOrItem)
SELECT 3 AS ClientId, 8 AS ParentCategoryId, 1 AS SeqNum, 102 AS CategoryId, NULL AS ItemId, '' ProcessType, 'Category' AS CategoryOrItem UNION
SELECT 3 AS ClientId, 8 AS ParentCategoryId, 2 AS SeqNum, 103 AS CategoryId, NULL AS ItemId, '' ProcessType, 'Category' AS CategoryOrItem UNION
SELECT 3 AS ClientId, 8 AS ParentCategoryId, 3 AS SeqNum, 100 AS CategoryId, NULL AS ItemId, '' ProcessType, 'Category' AS CategoryOrItem UNION
SELECT 3 AS ClientId, 8 AS ParentCategoryId, 4 AS SeqNum, 101 AS CategoryId, NULL AS ItemId, '' ProcessType, 'Category' AS CategoryOrItem UNION
SELECT 3 AS ClientId, 8 AS ParentCategoryId, 5 AS SeqNum, 7 AS CategoryId, NULL AS ItemId, '' ProcessType, 'Category' AS CategoryOrItem
...
FROM RetailSlnSch.Item WHERE ItemId BETWEEN 1 AND 215
