...
UPDATE ArchLib.ApplicationDefault SET ClientId = @ClientId, KVPValue = 'India Pvt Ltd' WHERE ClientId = @ClientId AND KVPKey = 'BusinessNameWord3'
...
USE [master]
GO
BACKUP DATABASE [DivineBija.in] TO DISK = 'C:\Dev\Database\Backup\DivineBija.in.BAK' WITH INIT
GO
