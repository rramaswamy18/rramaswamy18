    ...
    public partial class RetailSlnBL
    {
        ...
        public string AddToCart(ref PaymentInfoModel paymentInfoModel, string itemIdParm, string orderQtyParm, bool createOrderWIP, SqlConnection sqlConnection, SessionObjectModel sessionObjectModel, SessionObjectModel createForSessionObject, Controller controller, HttpSessionStateBase httpSessionStateBase, ModelStateDictionary modelStateDictionary, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            ...
            try
            {
                ...
                if (errorMessage == "")
                {
                    ...
                    //    CreateOrderWIP(ref paymentInfoModel, applSessionObjectModel.CorpAcctLocationId, itemId, orderQty, sqlConnection, sessionObjectModel, createForSessionObject, controller, httpSessionStateBase, modelStateDictionary, clientId, ipAddress, execUniqueId, loggedInUserId);
                    //}
                }
                exceptionLogger.LogInfo(methodName, Utilities.GetCallerLineNumber(), "00090000 :: Exit");
                return errorMessage;
        ...
        public void CreateInvoice(PaymentInfoModel paymentInfoModel, Controller controller, SessionObjectModel sessionObjectModel, SessionObjectModel createForSessionObject, HttpSessionStateBase httpSessionStateBase, ModelStateDictionary modelStateDictionary, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            ...
            try
            {
                ...
                paymentInfoModel.OrderSummaryModel.InvoiceHtmlString = emailBodyHtml;//archLibBL.ViewToHtmlString(controller, "_OrderInvoice", paymentInfoModel);
                if (paymentInfoModel.OrderSummaryModel.InvoiceTypeId == InvoiceTypeEnum.FinalInvoice)
                {
                }
                else
        ...
        public void CreateOrderWIP(ref PaymentInfoModel paymentInfoModel, SessionObjectModel sessionObjectModel, SessionObjectModel createForSessionObject, Controller controller, HttpSessionStateBase httpSessionStateBase, ModelStateDictionary modelStateDictionary, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            ...
            try
            {
                ...
                {//If Session has items add it to database - This has been added prior to logging in
                    ...
                    {
                        maxSeqNum = 0;
                        orderHeaderWIPModel = CreateOrderHeaderWIPModel(applSessionObjectModel.CorpAcctLocationId, paymentInfoModel.OrderSummaryModel.InvoiceTypeId, sessionObjectModel, createForSessionObject, controller, httpSessionStateBase, modelStateDictionary, clientId, ipAddress, execUniqueId, loggedInUserId);
        ...
        private void CreateOrder(PaymentInfoModel paymentInfoModel, string paymentOrderId, string paymentId, SqlConnection sqlConnection, SessionObjectModel sessionObjectModel, SessionObjectModel createForSessionObject, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            ...
            try
            {
                ...
                paymentInfoModel.OrderSummaryModel.UserFullName = createForSessionObject.FirstName + " " + createForSessionObject.LastName;
            ...
            try
            {
                ...
                else
                {
                    if (paymentInfoModel.OrderHeaderWIPModel == null)
                    {
                        ...
                        paymentInfoModel.OrderHeaderWIPModel = CreateOrderHeaderWIPModel(corpAcctLocationId, paymentInfoModel.OrderSummaryModel.InvoiceTypeId, sessionObjectModel, createForSessionObject, controller, httpSessionStateBase, modelStateDictionary, clientId, ipAddress, execUniqueId, loggedInUserId);
        ...
        private OrderHeaderWIPModel CreateOrderHeaderWIPModel(long corpAcctLocationId, InvoiceTypeEnum? invoiceTypeId, SessionObjectModel sessionObjectModel, SessionObjectModel createForSessionObject, Controller controller, HttpSessionStateBase httpSessionStateBase, ModelStateDictionary modelStateDictionary, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            string methodName = MethodBase.GetCurrentMethod().Name;
            ExceptionLogger exceptionLogger = Utilities.CreateExceptionLogger(Utilities.GetApplicationValue("ApplicationName"), ipAddress, execUniqueId, loggedInUserId, Assembly.GetCallingAssembly().FullName, Assembly.GetExecutingAssembly().FullName, MethodBase.GetCurrentMethod().DeclaringType.ToString());
            exceptionLogger.LogInfo(methodName, Utilities.GetCallerLineNumber(), "00000000 :: Enter");
        ...
        // PRIVATE : LoadOrderWIPBackup
        private void LoadOrderWIPBackup(Controller controller, SessionObjectModel sessionObjectModel, SessionObjectModel createForSessionObject, HttpSessionStateBase httpSessionStateBase, ModelStateDictionary modelStateDictionary, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            string methodName = MethodBase.GetCurrentMethod().Name;
            ExceptionLogger exceptionLogger = Utilities.CreateExceptionLogger(Utilities.GetApplicationValue("ApplicationName"), ipAddress, execUniqueId, loggedInUserId, Assembly.GetCallingAssembly().FullName, Assembly.GetExecutingAssembly().FullName, MethodBase.GetCurrentMethod().DeclaringType.ToString());
            exceptionLogger.LogInfo(methodName, Utilities.GetCallerLineNumber(), "00000000 :: Enter");
            try
            {
                ...
                else
                {
                    ApplicationDataContext.OpenSqlConnection();
                    OrderHeaderWIPModel orderHeaderWIPModel;
                    //If shopping cart has items prior to logging - use this after deleting in database
                    PaymentInfoModel paymentInfoModel = (PaymentInfoModel)httpSessionStateBase["PaymentInfo"];
                    CreatePaymentInfoModel(ref paymentInfoModel, sessionObjectModel, createForSessionObject, controller, httpSessionStateBase, modelStateDictionary, clientId, ipAddress, execUniqueId, loggedInUserId);
                    if (paymentInfoModel?.ShoppingCartModel?.ShoppingCartItemModels?.Count > 0)
                    {
                        ApplicationDataContext.OrderDetailWIPsDelete(createForSessionObject.PersonId, ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId);
                        ApplicationDataContext.OrderHeaderWIPDelete(createForSessionObject.PersonId, ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId);
                        ApplSessionObjectModel applSessionObjectModel = (ApplSessionObjectModel)createForSessionObject?.ApplSessionObjectModel;
                        //Create Order Header WIP
                        paymentInfoModel.OrderHeaderWIPModel = CreateOrderHeaderWIPModel(applSessionObjectModel.CorpAcctLocationId, paymentInfoModel.OrderSummaryModel.InvoiceTypeId, sessionObjectModel, createForSessionObject, controller, httpSessionStateBase, modelStateDictionary, clientId, ipAddress, execUniqueId, loggedInUserId);
                        ApplicationDataContext.OrderHeaderWIPAdd(paymentInfoModel.OrderHeaderWIPModel, ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId);
                        OrderDetailWIPModel orderDetailWIPModel;
                        foreach (var shoppingCartItemModel in paymentInfoModel.ShoppingCartModel.ShoppingCartItemModels)
                        {
                            paymentInfoModel.OrderHeaderWIPModel.OrderDetailWIPModels.Add
                            ...
                            ApplicationDataContext.OrderDetailWIPAdd(orderDetailWIPModel, ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId);
                        }
                    }
                    else
                    {
                        //Get Max Order Header Id for the created for user
                        long? orderHeaderWIPId = ApplicationDataContext.OrderHeaderWIPMaxIdGet(createForSessionObject.PersonId, ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId);
                        if (orderHeaderWIPId != null)
                        {
                            ...
                            if (orderHeaderWIPModel != null)
                            {
                                ...
                                //Build Shopping Cart
                                CreatePaymentInfoModel(ref paymentInfoModel, sessionObjectModel, createForSessionObject, controller, httpSessionStateBase, modelStateDictionary, clientId, ipAddress, execUniqueId, loggedInUserId);
                                paymentInfoModel.OrderSummaryModel.InvoiceTypeId = (InvoiceTypeEnum)orderHeaderWIPModel.InvoiceTypeId;
