    ...
    public class RetailSlnCacheBL
    {
        public void Initialize(out RetailSlnInitModel retailSlnInitModel, long clientId, string ipAddress, string execUniqueId, string loggedInUserId)
        {
            ...
            retailSlnInitModel = new RetailSlnInitModel
            {
                ...
                ItemItemSpecModels = ApplicationDataContext.ItemItemSpecList(ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId),
                ItemMasterItemSpecModels = ApplicationDataContext.ItemMasterItemSpecList(ApplicationDataContext.SqlConnectionObject, clientId, ipAddress, execUniqueId, loggedInUserId),
