...
{
    public class RetailSlnBackupController : Controller
    {
        #region
        ...
        //            {
        //                PaymentInfo1Model paymentInfoModel = retailSlnBL.DeliveryInfo(checkoutModel.ShoppingCartModel, (SessionObjectModel)Session["SessionObject"], false, true, clientId, ipAddress, execUniqueId, loggedInUserId);
        ...
        //            PaymentInfo1Model paymentInfoModel = retailSlnBL.DeliveryInfo(shoppingCartModel, (SessionObjectModel)Session["SessionObject"], false, true, clientId, ipAddress, execUniqueId, loggedInUserId);
        //            success = true;
        //            processMessage = "SUCCESS!!!";
        ...
        //        SessionObjectModel sessionObjectModel = archLibBL.CheckoutGuest(ref loginUserProfGuestModel, Session, ModelState, clientId, ipAddress, execUniqueId, loggedInUserId);
        //        if (ModelState.IsValid)
        //        {
        //            Session["SessionObject"] = sessionObjectModel;
        //            Session.Timeout = int.Parse(ConfigurationManager.AppSettings["AccessTokenExpiryMinutes"]);
        ...
        //    {
        //        exceptionLogger.LogError(methodName, Utilities.GetCallerLineNumber(), "00099000 :: Exception", exception);
        //        archLibBL.GenerateCaptchaQuesion(Session, "CaptchaNumberLoginUserProfGuest0", "CaptchaNumberLoginUserProfGuest1");
        //        loginUserProfGuestModel.CaptchaAnswerLoginUserProfGuest = null;
        //        loginUserProfGuestModel.CaptchaNumberLoginUserProfGuest0 = Session["CaptchaNumberLoginUserProfGuest0"].ToString();
        //        loginUserProfGuestModel.CaptchaNumberLoginUserProfGuest1 = Session["CaptchaNumberLoginUserProfGuest1"].ToString();
        //        archLibBL.CreateSystemError(ModelState, clientId, ipAddress, execUniqueId, loggedInUserId);
        //        htmlString = archLibBL.ViewToHtmlString(this, "_CheckoutGuestData", loginUserProfGuestModel);
        //        success = false;
        //        processMessage = "ERROR???";
        ...
        //        SessionObjectModel sessionObjectModel = (SessionObjectModel)Session["SessionObject"];
        //        ShoppingCartModel shoppingCartModel = (ShoppingCartModel)Session["ShoppingCartModel"];
        //        retailSlnBL.BuildDeliveryInfoLookup(paymentInfoModel, shoppingCartModel, sessionObjectModel, false, true, clientId, ipAddress, execUniqueId, loggedInUserId);
        //        ModelState.Clear();
        //        if (
        ...
        //                }
        //            }
        //            retailSlnBL.DeliveryInfo(paymentInfoModel, shoppingCartModel, sessionObjectModel, false, true, clientId, ipAddress, execUniqueId, loggedInUserId);
        ...
        //    if (success)
        //    {
        //        htmlString = archLibBL.ViewToHtmlString(this, "_PaymentInfo1", paymentInfoModel);
        //    }
        //    else
        //    {
        //        paymentInfoModel.ResponseObjectModel.ResponseTypeId = ResponseTypeEnum.Error;
        ...
        //[Authorize]
        //[HttpPost]
        //public ActionResult PaymentInfo4(GiftCertPaymentModel giftCertPaymentModel)
        //{//Credit Card Synchronous - Before processing
        //    bool success;
        //    string processMessage, htmlString;
        //    ArchLibBL archLibBL = new ArchLibBL();
        //    ActionResult actionResult;
        //    ShoppingCartModel shoppingCartModel = (ShoppingCartModel)Session["ShoppingCartModel"];
        //    SessionObjectModel sessionObjectModel = (SessionObjectModel)Session["SessionObject"];
        //    ProcessCreditCardModel processCreditCardModel = new ProcessCreditCardModel
        //    {
        //        CreditCardProcessModel = new CreditCardProcessModel
        //        {
        //            CreditCardPaymentAmount = shoppingCartModel.ShoppingCartSummaryItems.First(x => x.OrderDetailTypeId == OrderDetailTypeEnum.BalanceDue).OrderAmount,
        //            EmailAddress = sessionObjectModel.EmailAddress,
        //            UserFullName = (sessionObjectModel.FirstName + " " + sessionObjectModel.LastName).Trim(),
        //        },
        //        GiftCertPaymentModel = giftCertPaymentModel,
        ...
        //{//Credit Card Synchronous - After processing
        //    string methodName = MethodBase.GetCurrentMethod().Name, ipAddress = Utilities.GetIPAddress(Request), loggedInUserId = "";
        //    ExceptionLogger exceptionLogger = Utilities.CreateExceptionLogger(Utilities.GetApplicationValue("ApplicationName"), ipAddress, execUniqueId, loggedInUserId, Assembly.GetCallingAssembly().FullName, Assembly.GetExecutingAssembly().FullName, MethodBase.GetCurrentMethod().DeclaringType.ToString());
        //    exceptionLogger.LogInfo(methodName, Utilities.GetCallerLineNumber(), "00000000 :: Enter");
        //    bool success;
        ...
        //        //    },
        //        //};
        //        htmlString = archLibBL.ViewToHtmlString(this, "_CreditCardProcess", creditCardProcessModel);
        //        actionResult = Json(new { success, processMessage, htmlString }, JsonRequestBehavior.AllowGet);
        //    }
        //    return actionResult;
        //}
